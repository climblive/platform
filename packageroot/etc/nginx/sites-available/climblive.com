server {
	...
	location = / {
		...
		add_header Content-Security-Policy "default-src 'self'; script-src 'self' 'sha256-jIhoHP5AYEa/rjrf399lCKS/+7hIAc+G1cKDLBSPd7o='; style-src 'self' https://fonts.googleapis.com 'unsafe-inline'; frame-ancestors 'none'; form-action 'none'; base-uri 'self'";
