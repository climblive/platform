server {
	...
	add_header Content-Security-Policy "default-src 'self'; connect-src 'self' clmb.auth.eu-west-1.amazoncognito.com api.labs.climblive.app data:; style-src 'self' https://fonts.googleapis.com 'unsafe-inline'; font-src 'self' https://fonts.gstatic.com; object-src 'none'; frame-ancestors 'none'; form-action 'none'; base-uri 'self'";
