-- +goose Up
ALTER TABLE `contest` ADD COLUMN `name_retention_time` INT NOT NULL DEFAULT 20160;
...
SET c.scrub_before = DATE_ADD(cc.time_end, INTERVAL ct.name_retention_time MINUTE)
