...
CREATE TABLE IF NOT EXISTS `contest` (
  ...
  `name_retention_time` INT NOT NULL DEFAULT 604800,
...
CREATE TABLE IF NOT EXISTS `contender` (
  ...
  `scrubbed_at` TIMESTAMP NULL DEFAULT NULL,
  `scrub_before` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE INDEX `idx_contender_scrub` ON `contender` (`name` ASC, `scrub_before` ASC);
