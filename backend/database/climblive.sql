...
CREATE INDEX `index3` ON `series` (`id` ASC, `organizer_id` ASC) VISIBLE;
...
CREATE INDEX `fk_contest_3` ON `contest` (`series_id` ASC, `organizer_id` ASC) VISIBLE;

CREATE INDEX `index5` ON `contest` (`id` ASC, `organizer_id` ASC) VISIBLE;
...
CREATE INDEX `fk_comp_class_1_idx` ON `comp_class` (`contest_id` ASC, `organizer_id` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `contender` (
  ...
  `club` VARCHAR(128) NULL DEFAULT NULL,
  `class_id` INT NULL,
...
CREATE INDEX `fk_contender_2_idx` ON `contender` (`contest_id` ASC, `organizer_id` ASC) VISIBLE;

CREATE INDEX `index5` ON `contender` (`id` ASC, `organizer_id` ASC, `contest_id` ASC) VISIBLE;
...
CREATE INDEX `fk_problem_1_idx` ON `problem` (`contest_id` ASC, `organizer_id` ASC) VISIBLE;

CREATE UNIQUE INDEX `index3` ON `problem` (`number` ASC, `contest_id` ASC) VISIBLE;

CREATE INDEX `index5` ON `problem` (`id` ASC, `organizer_id` ASC, `contest_id` ASC) VISIBLE;
...
CREATE INDEX `fk_tick_1_idx` ON `tick` (`problem_id` ASC, `organizer_id` ASC, `contest_id` ASC) VISIBLE;

CREATE INDEX `fk_tick_2_idx` ON `tick` (`contender_id` ASC, `organizer_id` ASC, `contest_id` ASC) VISIBLE;
...
CREATE INDEX `fk_raffle_1_idx` ON `raffle` (`contest_id` ASC, `organizer_id` ASC) VISIBLE;

CREATE INDEX `index3` ON `raffle` (`id` ASC, `organizer_id` ASC) VISIBLE;
...
CREATE INDEX `fk_raffle_winner_1_idx` ON `raffle_winner` (`raffle_id` ASC, `organizer_id` ASC) VISIBLE;

CREATE INDEX `fk_raffle_winner_2_idx` ON `raffle_winner` (`contender_id` ASC, `organizer_id` ASC) VISIBLE;
